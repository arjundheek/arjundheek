...
class Brand(models.Model):
    ...
    logo = models.ImageField(default='', blank=True, upload_to='static/uploads/brands/logos')
...
class Product(models.Model):
    ...
    image_1 = models.ImageField(default='', blank=True, upload_to='static/uploads/products')
    image_2 = models.ImageField(default='', blank=True, upload_to='static/uploads/products')
    ...
    gender = models.CharField(max_length=15, default='', blank=True, choices=[('man', 'Man'), ('woman', 'Woman'), ('boy', 'Boy'), ('girl', 'Girl'), ('babyboy', 'Baby Boy'), ('babygirl', 'Baby Girl')])
    url = models.CharField(max_length=255, default='', blank=True)
    price = models.DecimalField(max_digits=19, decimal_places=2)
    try_on_main_image = models.ImageField(default='', blank=True, upload_to='static/uploads/products')
    try_on_image1 = models.ImageField(default='', blank=True, upload_to='static/uploads/products')
    try_on_image2 = models.ImageField(default='', blank=True, upload_to='static/uploads/products')
...
class Banner(models.Model):
    ...
    page = models.CharField(max_length=50, default='', blank=True, choices=[('brand', 'Brand'), ('categories', 'Categories'), ('products', 'Products'), ('tryons', 'Tryons')])
